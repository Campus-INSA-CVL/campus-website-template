---
title: carousel, image, social & team
description: Ceci est un template pour montrer l'utilisation et le rendu d'un carousel avec le une image de présentation, les réseaux sociaux et l'équipe !
color: carouselImageSocialTeamColor
order: 10
imagesName:
  - 'carousel-1.jpg'
  - 'carousel-2.jpg'
...
<campus-center>
  <campus-carousel :names="imagesName" folder-name="img"></campus-carousel>
</campus-center>
